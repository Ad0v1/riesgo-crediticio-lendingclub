...
# --- 2. SUBIR Y CARGAR DATOS ---
print("Por favor, sube los archivos 'train2_prestamos.csv' y 'test2_prestamos.csv'")
uploaded = files.upload()  # Sube ambos CSV
...
y_proba = modelo.predict_proba(X_test)[:, 1]  # Probabilidad de 'Fully Paid'
...
# --- 9. GUARDAR Y DESCARGAR RESULTADOS ---
df_to_save = df_resultados
df_to_save.to_csv('prediccion_prestamos.csv', index=False)
files.download('prediccion_prestamos.csv')
